...
class Data {
  ...
  List<IdentityProofDetail>? identityProofDetail;
  List<RegistrationDetail>? registrationDetail;
  List<EstablishmentDetail>? establishmentDetail;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['identity_proof_detail'] != null) {
      ...
      json['identity_proof_detail'].forEach((v) {
        identityProofDetail!.add(new IdentityProofDetail.fromJson(v));
      });
    }
    ...
    if (json['establishment_detail'] != null) {
      ...
      json['establishment_detail'].forEach((v) {
        establishmentDetail!.add(new EstablishmentDetail.fromJson(v));
      });
    }
...
class RegistrationDetail {
  ...
  RegistrationDetail.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    identityProofNo = json['identity_proof_no'];
    file = json['file'];
    description = json['description'];
    status = json['status'];
    isDeleted = json['is_deleted'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = this.id;
    data['name'] = this.name;
    data['identity_proof_no'] = this.identityProofNo;
    data['file'] = this.file;
    data['description'] = this.description;
    data['status'] = this.status;
    data['is_deleted'] = this.isDeleted;
...
class Autogenerated {
  ...
  Autogenerated({this.registrationDetail});
...
class User {
  ...
  User({this.username, this.name, this.userId, this.email});
...
class EstablishmentDetail {
  ...
  EstablishmentDetail.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    identityProofType = json['identity_proof_type'];
    identityProofNo = json['identity_proof_no'];
    file = json['file'];
    description = json['description'];
    status = json['status'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = this.id;
    data['name'] = this.name;
    data['identity_proof_type'] = this.identityProofType;
    data['identity_proof_no'] = this.identityProofNo;
    data['file'] = this.file;
    data['description'] = this.description;
    data['status'] = this.status;

...
class Apis {
  ...
  static const String  doctors_list           = "api/doctors-list";
 ...
 // get-specialty
  static const String  book_appointment_list  = "api/appointments";
  static const String  medicine_detail        = "medicine_details/{id}";
  static const String  user_book_appointment  = "api/book_appointment";
  ...
  static const String  delete_address         = "api/delete_address/{id}";
  ...
  static const String  treatmentWise_doctor   = "api/treatment_wise_doctor/";
  //familymember
  static const String  familymember   = "api/familymember/";
  ...
  static const  String Plans =  "api/get-plans";
  static const  String addmembers =  "api/post-familymember";
}
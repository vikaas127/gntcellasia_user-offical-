...
class _cancelappointment extends State<cancelappointment> {
                    ...
                    child: Center(
                      ...
                      Column(
                        children: [
                          ...
                          caneclappointmentreq.length == 0 ? Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  getTranslated(context, cancel_appointment_length).toString()
                                   + " ${caneclappointmentreq.length} ",
                                  style:
                                  TextStyle(fontSize: 13, color: passwordVisibility),
                                ),
                              ],
                            ),
                          ),
                           ...
                           ListView.builder(
                            ...
                            itemBuilder: (context, i) {
                                                ...
                                                Container(
                                                  child: ListTile(
                                                    ...
                                                    title: Container(
                                                      ...
                                                      child: Text(_searchResult[i].patientName!,
                                                          style: TextStyle(fontSize: 16.0),overflow: TextOverflow.ellipsis,maxLines: 1,),
                                                    ),
                                                    trailing: Container(
                                                        child: Text(
                              ...
                              : Container(
                               height: height/1.5,
                               child: Center(child: Container(margin:EdgeInsets.only(top: height*0.02),child: Text(getTranslated(context, result_not_found).toString()),))):
                          ListView.builder(
                                            ...
                                            child: Column(children: <Widget>[
                                              Container(
                                                child: ListTile(
                                                  ...
                                                  trailing: Container(
                                                      child: Text(
                                                        SharedPreferenceHelper.getString(Preferences.currency_symbol) + caneclappointmentreq[index].amount.toString(),
                                                        style: TextStyle(
                                                            fontSize: 16,
                                                            color: hintColor),
                                                      )),
                                                  subtitle: Column(
                                                    children: <Widget>[
                                                      Container(
                                                          ...
                                                          AlignmentDirectional.topStart,
                                                          child: Text(
                                                            getTranslated(context, home_age_data).toString() + ":" + caneclappointmentreq[index].age.toString(),
                                                            style: TextStyle(
                                                                fontSize: 12,
                                                                color: hintColor),
                                                          )),
  ...
  Future <void> logoutUser() async{
    ...
    Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder:(BuildContext context) => SignIn()),

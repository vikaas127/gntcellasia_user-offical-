...
class _loginhomeState extends State<loginhome> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero,(){
      ...
      print(SharedPreferenceHelper.getString(Preferences.currency_symbol));
                          ...
                          : Center(
                            child: Column(
                              ...
                              children: [
                                isfilled == 0
                                    ? GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          margin: EdgeInsets.only(
                                              left: width * 0.06, right: width * 0.06,bottom: height*0.02),
                                          child: Column(
                                            children: [
                                              Row(
                                                children: [
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                       ...
                                       GestureDetector(
                                         ...
                                         child: todayappointmentsreq.length < 5  ? Container() :Container(child: Text(getTranslated(context, home_show_all).toString(),
                                           style: TextStyle(
                               ...
                               todayappointmentsreq.length == 0 ?  Center(
                                 child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                style: TextStyle(
                    fontSize: 20, color: hintColor, decoration: TextDecoration.none),
              ...
              GestureDetector(
                ...
                child: Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          fontSize: 14, color: darkGrey, decoration: TextDecoration.none),
                      textAlign: TextAlign.center,
                    )),
              ),
              SizedBox(

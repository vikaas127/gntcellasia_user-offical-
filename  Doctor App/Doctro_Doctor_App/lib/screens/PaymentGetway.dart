...
class PaymentGetway extends StatefulWidget {
  ...
  PaymentGetway(String? plan, int? values, int? id) {
    this.plan = plan;
    this.value = values;
    this.id = id;
  }
  ...
  @override
  _PaymentGetwayState createState() => _PaymentGetwayState(plan, value, id);
}
...
class _PaymentGetwayState extends State<PaymentGetway> {
  ...
  _PaymentGetwayState(String? plan, int? value, int? id) {
    this.plan = plan;
    this.value = value;
    this.id = id;
  }
  ...
  Future<BaseModel<Setting>> settingrequest() async {
    ...
    try {
      ...
      if (response.success == true) {
        ...
        setState(() {
          bussiness_name = response.data!.businessName;

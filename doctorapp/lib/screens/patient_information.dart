...
class patientinformation extends StatefulWidget {
  ...
  patientinformation(int? id) {
    this.id = id;
  }

  @override
  _patientinformationState createState() => _patientinformationState(id);
}
...
class _patientinformationState extends State<patientinformation> with TickerProviderStateMixin {
  //Set Loader
  Future? appointmentdetial;

  //Pdf Pass Data
  String? value_medicine;
  String? value_days;
  bool? alert_valuefirst = false;
  bool? alert_valuesecond = false;
  bool? alert_valuethird = false;
  ...
  _patientinformationState(int? id) {
    this.id = id;
  }
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: GestureDetector(
                                              onTap: () {
                                                _days.clear();
                                                alert_valuefirst = false;
                                                alert_valuesecond = false;
                                                alert_valuethird = false;
                                                                                ...
                                                                                Container(
                                                                                  child: Transform.scale(
                                                                                    ...
                                                                                    child: Checkbox(
                                                                                      ...
                                                                                      value: this.alert_valuefirst,
                                                                                      onChanged: (bool? value) {
                                                                                        mystate(() {
                                                                                          this.alert_valuefirst = value;
                                                                                        });
                                                                                      },
                                                                                    ),
                                                                                  ),
                                                                                ...
                                                                                Container(
                                                                                  ...
                                                                                  child: Transform.scale(
                                                                                    ...
                                                                                    child: Checkbox(
                                                                                      checkColor: loginButton,
                                                                                      activeColor: hintColor,
                                                                                      value: this.alert_valuesecond,
                                                                                      onChanged: (bool? value) {
                                                                                        mystate(() {
                                                                                          this.alert_valuesecond = value;
                                                                                        });
                                                                                      },
                                                                                    ),
                                                                                  ),
                                                                                ...
                                                                                Container(
                                                                                  ...
                                                                                  child: Transform.scale(
                                                                                    ...
                                                                                    child: Checkbox(
                                                                                      checkColor: loginButton,
                                                                                      activeColor: hintColor,
                                                                                      value: this.alert_valuethird,
                                                                                      onChanged: (bool? value) {
                                                                                        mystate(() {
                                                                                          this.alert_valuethird = value;
                                                                                        });
                                                                                      },
                                                                                    ),
                                                                                  ),
                                                                ...
                                                                OutlinedButton(
                                                                  ...
                                                                  onPressed: () {
                                                                    if (selectedMedicineValue == null) {
                                                                      ...
                                                                      param['morning'] = alert_valuefirst;
                                                                      param['afternoon'] = alert_valuesecond;
                                                                      param['night'] = alert_valuethird;
  ...
  Future<BaseModel<Appointmentdetails>> appointmentDetails() async {
    ...
    try {
      ...
      setState(() {
        ...
        drug_effect = response.data!.drugEffect;

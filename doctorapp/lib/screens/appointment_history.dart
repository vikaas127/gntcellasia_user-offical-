...
class appointmenthistory extends StatefulWidget {
  @override
  _appointmenthistory createState() => _appointmenthistory();
}

class _appointmenthistory extends State<appointmenthistory>  with TickerProviderStateMixin {
  ...
  void didChangeDependencies() {
    ...
    _drawer = [
      getTranslated(context,drawer_home).toString(),getTranslated(context,drawer_payments).toString(),getTranslated(context,drawer_canceled_appointment).toString(),getTranslated(context,drawer_appointments).toString(),getTranslated(context,drawer_review).toString(),getTranslated(context,drawer_notification).toString(),getTranslated(context,drawer_schedule_timing).toString(),getTranslated(context,drawer_subscription_history).toString(),getTranslated(context,drawer_change_password).toString(),getTranslated(context,drawer_change_language).toString(),getTranslated(context,drawer_logout).toString(),
    ];

    _drawerMenu = [
      getTranslated(context,drawer_home).toString(),getTranslated(context,drawer_payments).toString(),getTranslated(context,drawer_canceled_appointment).toString(),getTranslated(context,drawer_appointments).toString(),getTranslated(context,drawer_review).toString(),getTranslated(context,drawer_notification).toString(),getTranslated(context,drawer_schedule_timing).toString(),getTranslated(context,drawer_change_password).toString(),getTranslated(context,drawer_change_language).toString(),getTranslated(context,drawer_logout).toString(),
    ];
  }
  ...
  void initState(){
    super.initState();
      Future.delayed(Duration.zero,(){
        ...
        tabList.add(new Tab(
          child: Text(getTranslated(context, upcoming_appointment).toString(),textAlign: TextAlign.center,),
        ));
        tabList.add(new Tab(
          child: Text(getTranslated(context, past_appointment).toString(),textAlign: TextAlign.center,),
        ));
        ...
        appointimenth = appointmenthistory();
              ...
              drawer: Drawer(
                child: Column(
                  children: [
                    ...
                    Expanded(
                      flex: 11,
                      child: subscription == -1 ? ListView.builder(
                          ...
                          return ListTile(
                            onTap: (){
                              if( _drawerMenu[index] == getTranslated(context, drawer_home).toString()){
                                ...
                                Navigator.popAndPushNamed(context, 'appointmenthistory');
                              }
                            ...
                            title:
                            Text(_drawerMenu[index],style: TextStyle(color: hintColor),),);
                        },
                      ): ListView.builder(
                        physics: AlwaysScrollableScrollPhysics(),
                        shrinkWrap: false,
                        ...
                        itemBuilder: (context, index) {
                          return ListTile(
                            ...
                            title:
                            Text(_drawer[index],style: TextStyle(color: hintColor),),);
                        },
                      ),
                    ),
                  ],
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Container(
                                        child:
                                       hospitalName == null ? Container() : Text('$hospitalName'),
                                      ),
                                     hospitalAddress == null ? Container() : Container(
                                       width: width * 0.6,
                                       child: Text(
                                         "$hospitalAddress",overflow: TextOverflow.ellipsis,
                                         maxLines: 2,
                            ...
                            child: Container(
                                ...
                                child:Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      child: SvgPicture.asset(
                                        'assets/icons/dsearch.svg',height: 20,
                                      ),
                                    ),
                                  ],
                                )
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TabBarView(
                                        controller: _tabController,
                                        children: [
                                          upcomingappointmentreq.length == 0 ?  Container(
                                            child: Center(
                                                      ...
                                                      children: <Widget>[
                                                        Container(
                                                          child: ListTile(
                                                            ...
                                                            trailing: Container(
                                                              child: Text(_searchResult[i].appointmentStatus!.toUpperCase(),style: TextStyle(color:statusColor),),
                                                            ),
                                                            subtitle: Column(
                                                              crossAxisAlignment:
                                                              CrossAxisAlignment.start,
                                            ...
                                            itemBuilder: (context, index) {
                                              var statusColor = status;
                                              if (upcomingappointmentreq[index]
                                                  .appointmentStatus!
                                                  .toUpperCase() ==
                                                  getTranslated(context, status_pending).toString()) {
                                                statusColor = hintColor.withOpacity(0.6);
                                              } else if (upcomingappointmentreq[index]
                                                  .appointmentStatus!
                                                  .toUpperCase() ==
                                                  getTranslated(context, status_cancel).toString()) {
                                                statusColor = statusCancel;
                                                              ...
                                                              child: ListTile(
                                                                ...
                                                                title:Text(upcomingappointmentreq[index].patientName!,
                                                                    style: TextStyle(
                                                                        fontSize: 16.0)),
                                                                trailing: Container(
                                                                  child: Text(upcomingappointmentreq[index].appointmentStatus!.toUpperCase(),style: TextStyle(color:statusColor),),
                                                                ),
                                                                subtitle: Column(
                                                                  crossAxisAlignment:
                                                                  CrossAxisAlignment.start,
                                                                  children: <Widget>[
                                                                    ...
                                                                    Text(
                                                                      ...
                                                                      style: TextStyle(
                                                                          fontSize: 12,
                                                                          color: passwordVisibility),overflow: TextOverflow.ellipsis,maxLines: 2,
                                                                    ),
                                                                  ],
                                                                ),
                                                              ),
                                                                    ...
                                                                    child: Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          EdgeInsets.only(),
                                                                          child: Text(
                                                                              upcomingappointmentreq[index].doctorName!,
                                                                              style: TextStyle(
                                                                                   fontSize: 14,
                                                                                  color: hintColor)),
                                                                        ),
                                          ...
                                          pastappointmentreq.length == 0 ?  Container(
                                            height: height/2,
                                            child: Image.asset("assets/images/no-data.png"),
                                          ) :   _search.text.isNotEmpty ? _pastSearch.length > 0
                                                            ...
                                                            Container(
                                                              child: ListTile(
                                                                ...
                                                                title: Text(_pastSearch[i].patientName!,
                                                                    style: TextStyle(
                                                                        fontSize: 16.0)),
                                                                trailing: Container(child: Text(_pastSearch[i].appointmentStatus!.toUpperCase(),style: TextStyle(color: statusColor),),),
                                                                subtitle: Column(
                                                                  crossAxisAlignment:
                                                                  CrossAxisAlignment.start,
                                                                  children: <Widget>[
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: Column(
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                        getTranslated(context, doctor_name).toString(),
                                                                            style: TextStyle(
                                                                                fontSize: 14,
                                                                                color: passwordVisibility)),
                                                                        Container(
                                          ...
                                          ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              //Set Date Formate dd-mm-yy
                                              String date = DateUtil().formattedDate(DateTime.parse(pastappointmentreq[index].date!));
                                              var statusColor = status;
                                              if (pastappointmentreq[index]
                                                  .appointmentStatus!
                                                  .toUpperCase() ==
                                                  getTranslated(context, status_pending).toString()) {
                                                statusColor = hintColor.withOpacity(0.6);
                                              } else if (pastappointmentreq[index]
                                                  .appointmentStatus!
                                                  .toUpperCase() ==
                                                  getTranslated(context, status_cancel).toString()) {
                                                statusColor = statusCancel;
                                                            ...
                                                            Container(
                                                              child: ListTile(
                                                                ...
                                                                title: Text(pastappointmentreq[index].patientName!,
                                                                    style: TextStyle(
                                                                        fontSize: 16.0)),
                                                                trailing: Container(child: Text(pastappointmentreq[index].appointmentStatus!.toUpperCase(),style: TextStyle(color: statusColor),),),
                                                                subtitle: Column(
                                                                  crossAxisAlignment:
                                                                  CrossAxisAlignment.start,
                                                                  children: <Widget>[
                                                                    ...
                                                                    child: Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          EdgeInsets.only(),
                                                                          child: Text(
                                                                              pastappointmentreq[index].doctorName!,
                                                                              style: TextStyle(
                                                                                  fontSize: 14,
                                                                                  color: hintColor)),
                                                                        ),
  ...
  Future<BaseModel<Appointmenthistory>> appointmenthistory() async {
    ...
    try {
      ...
      _pastdata.clear();
      _userDetails.clear();
      response = await RestClient(RetroApi().dioData()).appointmenthistoryrequest();
      setState(() {
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget cancel = TextButton(
      child: Text(getTranslated(context, cancel_button).toString(),style: TextStyle(color: hintColor),),
      onPressed: () {
    ...
    Widget okButton = TextButton(
      child: Text(getTranslated(context, logout_button).toString(),style: TextStyle(color: hintColor),),
      onPressed: () {
  ...
  onSearchTextChanged(String text) async {
    ...
    isShow == null ? _userDetails.forEach((upcomingAppointment) {
      if (upcomingAppointment.patientName!.toLowerCase().contains(text.toLowerCase()))
        _searchResult.add(upcomingAppointment);
    }) :
    _pastdata.forEach((pastAppointment) {
      if (pastAppointment.patientName!.toLowerCase().contains(text.toLowerCase()))
        _pastSearch.add(pastAppointment);
    });

...
class _profile extends State<profile> {
  ...
  void didChangeDependencies() {
    ...
    gender = [getTranslated(context,gender_male).toString(),getTranslated(context,gender_female).toString(),];

    popular = [
      getTranslated(context,popular_yes).toString(),getTranslated(context,popular_no).toString(),
    ];
  }
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            DropdownButtonFormField<Hospitalname>(
                                              ...
                                              items: hospitalreq.map((label) => DropdownMenuItem<Hospitalname>(
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      TextField(
                                                        ...
                                                        controller: _degree,
                                                        decoration: InputDecoration(hintText: getTranslated(context, profile_dialog_degree_hint).toString()),
                                                      ),
                                                      TextField(
                                                        onChanged: (value) {
                                                          setState(() {
                                                        ...
                                                        controller: _college,
                                                        decoration: InputDecoration(hintText: getTranslated(context, profile_dialog_education).toString()),
                                                      ),
                                                      TextField(
                                                        onChanged: (value) {
                                                          setState(() {
                                                        ...
                                                        keyboardType: TextInputType.numberWithOptions(decimal: true),
                                                        inputFormatters: [new FilteringTextInputFormatter.allow(RegExp("[0-9]"))],
                                                        decoration: InputDecoration(hintText: getTranslated(context, profile_dialog_year_of_completion).toString()),
                                                      ),
                                                    ],
                                                  ),
                                                ),
                                                    ...
                                                    onPressed: () {
                                                      setState(() {
                                                        if(_degree.text.isNotEmpty && _college.text.isNotEmpty && _completeyear.text.isNotEmpty){
                                                          ...
                                                          callyear = valueyear;
                                                          addDegree = _Degree.text + "," + _degree.text;
                                                          addCollege = _College.text + "," + _college.text;
                                                          addYear = _Collegeyear.text + "," + _completeyear.text;

                                                          _Degree.text = addDegree;
                                                          _College.text = addCollege;
                                                          _Collegeyear.text = addYear;
                                                          _degree.clear();
                                                          _college.clear();
                                                          _completeyear.clear();
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        TextField(
                                                          ...
                                                          controller: _certificate,
                                                          decoration: InputDecoration(hintText: getTranslated(context, profile_dialog_certificate).toString()),
                                                        ),
                                                        TextField(
                                                          onChanged: (value) {
                                                            setState(() {
                                                          ...
                                                          keyboardType: TextInputType.numberWithOptions(decimal: true),
                                                          inputFormatters: [new FilteringTextInputFormatter.allow(RegExp("[0-9]"))],
                                                          decoration: InputDecoration(hintText: getTranslated(context, profile_dialog_year).toString()),
                                                        ),
                                                      ],
                                                    ),
                                                  ),
                                                      ...
                                                      onPressed: () {
                                                        setState(() {
                                                          ...
                                                          if(_certificate.text.isNotEmpty && _year.text.isNotEmpty){
                                                            ...
                                                            addCertificate = _Certificate.text + "," + _certificate.text;
                                                            addCertificateyear = _Certificateyear.text + "," + _year.text;
                                                            _Certificate.text = addCertificate;
                                                            _Certificateyear.text = addCertificateyear;
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          DropdownButtonFormField<TreatmentData>(
                                            ...
                                            iconSize: 35,
                                            items:
                                            treatmentreq.length > 1 ? treatmentreq.map((TreatmentData item) {
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          DropdownButtonFormField<CategoriesData>(
                                            ...
                                            iconSize: 35,
                                            items:
                                            categoryreq.length > 1 ? categoryreq.map((CategoriesData item) {
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          DropdownButtonFormField<Expert>(
                                            ...
                                            focusColor: red,
                                            iconSize: 35,
                                            items: expertreq.length > 1 ? expertreq.map((Expert item) {
                                            ...
                                            onTap: () async {
                                              ...
                                              if (result != null) {
                                                setState(() {
                                                  ...
                                                  checkData = int.parse(start_part!) ;
                                                  if(checkData > 9 ){
                                                    _Starttime.text = result.format(context).toLowerCase();
                                                  }else{
                                                    _Starttime.text = "0" + result.format(context).toLowerCase();
                                                  }
                                                });
                                              }
                                            },
                                            ...
                                            onTap: () async {
                                              ...
                                              if (result != null) {
                                                setState(() {
                                                  ...
                                                  checkData = int.parse(start_part!) ;
                                                  if(checkData > 9 ){
                                                    _Endtime.text = result.format(context).toLowerCase();
                                                  }else{
                                                    _Endtime.text = "0" + result.format(context).toLowerCase();
                                                  }
                                                });
                                              }
                                            },
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          DropdownButton(
                                            ...
                                            value: _selectedpopular == '0' ? getTranslated(context, popular_no).toString() : getTranslated(context, popular_yes).toString(),
                                            isExpanded: true,
                                            iconSize: 35,
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            ...
            if (_formkey.currentState!.validate()) {
              degree = _Degree.text.toString().split(",");
              college = _College.text.toString().split(',');
              year = _Collegeyear.text.toString().split(',');

              certificate = _Certificate.text.toString().split(',');
              certificateYear = _Certificateyear.text.toString().split(',');
              ...
              for (int i = 0; i < certificate.length; i++) {
                ...
                certificateData.certificate_year = certificateYear[i];

                      ...
                      Column(
                        children: [
                          ...
                          paymentsreq.length == 0 ?  Center(
                            ...
                            margin: EdgeInsets.only(
                                left: width * 0.06, right: width * 0.06, top: height * 0.020),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text(
                         ...
                         _search.text.isNotEmpty ? _searchResult.length  > 0 ?
                            ...
                            itemBuilder: (context, i) {
                              return Column(
                                children: [
                                  Container(
                                    margin: EdgeInsets.only(
                                        left: width * 0.06, top: height * 0.04, right: width * 0.06),
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Text(
                          ...
                          ) : Center(child: Container(margin:EdgeInsets.only(top: height*0.02),child: Text(getTranslated(context, result_not_found).toString(),),)) :
                          ListView.builder(
                            physics: NeverScrollableScrollPhysics(),
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          SharedPreferenceHelper.getString(Preferences.currency_symbol) + paymentsreq[index].amount.toString(),
                                          style: TextStyle(fontSize: 14, color: passwordVisibility),
                                        ),
                                      ],
                                    ),
                          ...
                          paymentsreq.length < 5 ? Container() : Visibility(
                         ...
                         paymentsreq.length == 0 ? Container() : Container(
                            height: height * 0.07,
                            width: width * 1.0,
